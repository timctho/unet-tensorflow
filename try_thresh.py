...
def search_thresh(thread_name):
    ...
    input_size = 1280
    pred_npy_dir = '/media/tim_ho/HDD1/Projects/kaggle-carvana/unet-pytorch/predictions/unet1280-35'
    flip_pred_npy_dir = '/media/tim_ho/HDD1/Projects/kaggle-carvana/unet-pytorch/predictions/unet1280-35'
    gt_mask_dir = '/home/tim_ho/Documents/Dataset_SSD/Carvana/png_masks'
    ...
    while True:
        ...
        for gt_img_path in os.listdir(gt_mask_dir):
            ...
            # data paths
            pred_npy_path = os.path.join(pred_npy_dir, img_name+'.npy')
            flip_pred_npy_path = os.path.join(flip_pred_npy_dir, 'flip_'+img_name+'.npy')
            ...
            gt_img = cv2.resize(gt_img, (input_size, input_size))
            ...
            # binarize mask
            if use_flip:
                prob_mask = (pred_npy + flip_pred_npy) / 2.0
        ...
        if mutex.acquire(1):
            ...
            print('{} mean dice = {}, best mean dice = {}'.format(thread_name, mean_dice, best_score['dice']))
            mutex.release()
